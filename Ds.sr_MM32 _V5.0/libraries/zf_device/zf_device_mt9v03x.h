...
#define LCDH                    (60)                                           //60 //64  /*!< 屏幕显示高度（用户使用）高度 */
#define LCDW                    (100)  
...
#define MT9V03X_EXP_TIME_DEF    (300)    //512                                   // 曝光时间         摄像头收到后会自动计算出最大曝光时间，如果设置过大则设置为计算出来的最大曝光值
#define MT9V03X_FPS_DEF         (60)   //50                                    // 图像帧率         摄像头收到后会自动计算出最大FPS，如果过大则设置为计算出来的最大FPS
...
extern uint8  image_twovalue[MT9V03X_H][MT9V03X_W];
